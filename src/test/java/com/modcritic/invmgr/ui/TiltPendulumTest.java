 ...
 * be; they are the observed behavior with a little slack, so that a change to the constants in
...
class TiltPendulumTest {
    ...
    void aSlowCrawlDoesNotJitter() {
        ...
        // reports whole pixels, so at 60 Hz that arrives as 1, 1, 0, 1, 1, 0; it was that
    ...
    void theLeanFollowsTheDirectionOfTheChange() {
        ...
        assertTrue(rightward < 0, "accelerating right should tilt counterclockwise");
