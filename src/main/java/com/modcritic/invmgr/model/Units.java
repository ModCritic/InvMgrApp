 ...
 * is stored in <b>feet</b>, and <b>nothing is ever stored in metric</b>. Centimeters and
 * meters exist only as a display conversion at the moment a number is shown to the user
...
public final class Units {
    ...
    /** Centimeters in an inch, exact by international definition. */
    public static final double CM_PER_IN = 2.54;

    /** Meters in a foot, exact by international definition. */
    public static final double M_PER_FT = 0.3048;

    /** Pixels per meter. Used for the metric grid; works out to ~314.96. */
    ...
    /**
     * Turns a dimension the user typed <b>in centimeters</b> into the inches value that
     * gets stored, following SPEC-2D-ENGINE.md §2's four steps in order:
     *
     * <ol>
     *   <li>round to 3 decimals <em>while still in centimeters</em>
     ...
     * typed is what makes the value convert back to the same centimeter reading it
     ...
     * orders disagree.
     *
     * <p>Storing 6 decimals of an inch is finer than any centimeter or millimeter the UI
